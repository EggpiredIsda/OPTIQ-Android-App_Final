  ...
  return (
    <div className="feature-page">
      ...
      <div className="camera-frame">
        <div style={{ width:56, height:56, borderRadius:'50%', border:'1.5px solid rgba(111,207,151,0.3)', display:'flex', alignItems:'center', justifyContent:'center' }}>
        ...
        <p className="camera-label">{scanning ? 'Scanning…' : 'Position your face in front of the camera'}</p>
      </div>
      ...
      <p style={{ fontSize:11, opacity:0.25, textAlign:'center', lineHeight:1.6 }}>
        Measurement accuracy ±1mm · Works in good lighting.<br />No images are stored or transmitted.
      </p>
    </div>
  );
}
